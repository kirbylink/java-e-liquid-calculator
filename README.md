...
2. Double-click the JAR file (you may need to make it executable first, depending on your OS) or, if your OS doesn't support this, run the JAR file:
   ```bash
   java -jar e-liquid-calculator-1.2.1-jar-with-dependencies.jar
   ```
...
1. Download `e-liquid-calculator-1.2.1-jar-with-dependencies-windows-x64.exe` or `e-liquid-calculator-1.2.1-jar-with-dependencies-windows-x64.zip` from the [Releases](https://github.com/kirbylink/java-e-liquid-calculator/releases) page and extract it.
...
1. Download `e-liquid-calculator-1.2.1-jar-with-dependencies-macos-x64.tar.gz` from the [Releases](https://github.com/kirbylink/java-e-liquid-calculator/releases) page and extract it.
2. Double-click `e-liquid-calculator-1.2.1-jar-with-dependencies-macos-x64.app`.
...
1. Download `e-liquid-calculator-1.2.1-jar-with-dependencies-linux-x64` or `e-liquid-calculator-1.2.1-jar-with-dependencies-linux-x64.tar.gz` from the [Releases](https://github.com/kirbylink/java-e-liquid-calculator/releases) page and extract it.
2. Make the file executable if necessary:
   ```bash
   chmod +x e-liquid-calculator-1.2.1-jar-with-dependencies-linux-x64
   ```
3. Double-click the executable to run the application, or if your OS doesn't support it, run the application:
   ```bash
   ./e-liquid-calculator-1.2.1-jar-with-dependencies-linux-x64
   ```
...
```bash
usage: java -jar e-liquid-calculator-1.2.1-jar-with-dependencies.jar
...
Example Input:
```bash
java -jar e-liquid-calculator-1.2.1-jar-with-dependencies.jar -a 800 -p 1
```
Result:
```bash
Required amounts
...
Example Input:
```bash
java -jar e-liquid-calculator-1.2.1-jar-with-dependencies.jar -a 800 -p 0.5 -v 0.5
```
Result:
```bash
Required amounts
...
```bash
java -Duser.language=de -Duser.country=DE -jar e-liquid-calculator-1.2.1-jar-with-dependencies.jar
```
...
- English (default):
  ```bash
  java -Duser.language=en -Duser.country=EN -jar e-liquid-calculator-1.2.1-jar-with-dependencies.jar
  ```
- German:
  ```bash
  java -Duser.language=de -Duser.country=DE -jar e-liquid-calculator-1.2.1-jar-with-dependencies.jar
...
1. Laden Sie `e-liquid-calculator-1.2.1-jar-with-dependencies-windows-x64.exe` oder `e-liquid-calculator-1.2.1-jar-with-dependencies-windows-x64.zip` von der [Releases](https://github.com/kirbylink/java-e-liquid-calculator/releases) Seite herunter und entpacken Sie es.
...
1. Laden Sie `e-liquid-calculator-1.2.1-jar-with-dependencies-macos-x64.tar.gz` von der [Releases](https://github.com/kirbylink/java-e-liquid-calculator/releases) Seite herunter und entpacken Sie es.
2. Doppelklicken Sie auf `e-liquid-calculator-1.2.1-jar-with-dependencies-macos-x64.app`.
...
1. Laden Sie `e-liquid-calculator-1.2.1-jar-with-dependencies-linux-x64` oder `e-liquid-calculator-1.2.1-jar-with-dependencies-linux-x64.tar.gz` von der [Releases](https://github.com/kirbylink/java-e-liquid-calculator/releases) Seite herunter und entpacken Sie es.
