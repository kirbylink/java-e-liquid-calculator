...
[![Alarmhinweise](https://sonarqube.phoenix.ipv64.de/api/project_badges/measure?project=de.dddns.kirbylink%3Ae-liquid-calculator&metric=alert_status&token=sqb_0821339dda892b80ccfbd777867d75a12dc8fc77)](https://sonarqube.phoenix.ipv64.de/dashboard?id=de.dddns.kirbylink%3Ae-liquid-calculator)
...
- [Deutsch](#deutsch)
  ...
  - [Installation und Verwendung](#installation-und-verwendung)
    ...
    - [Verwendung von Ausführbaren Dateien](#verwendung-von-ausführbaren-dateien)
      - [Windows](#windows-de)
      - [macOS](#macos-de)
      - [Linux](#linux-de)
  - [Verwendung](#verwendung)
    ...
    - [GUI](#gui-de)
      - [Speichern Ihrer Mischung](#speichern-ihrer-mischung)
  - [Lokalisierung](#lokalisierung)
    ...
    - [Sprach- und Ländereinstellungen in der GUI](#sprach-und-ländereinstellungen-in-der-gui)
  - [Projekt Bauen](#projekt-bauen)
  - [Löschen der Anwendung](#löschen-der-anwendung)
...
2. Double-click the JAR file (you may need to make it executable first, depending on your OS) or, if your OS doesn't support this, run the JAR file:
   ```bash
   java -jar e-liquid-calculator-1.0.0-jar-with-dependencies.jar
   ```
...
2. Make the file executable if necessary:
   ```bash
   chmod +x e-liquid-calculator-1.0.0-jar-with-dependencies-linux-x64
   ```
3. Double-click the executable to run the application, or if your OS doesn't support it, run the application:
   ```bash
   ./e-liquid-calculator-1.0.0-jar-with-dependencies-linux-x64
   ```
...
```bash
usage: java -jar e-liquid-calculator-1.0.0-jar-with-dependencies.jar
...
Example Input:
```bash
java -jar e-liquid-calculator-1.0.0-jar-with-dependencies.jar -a 800 -p 1
```
Result:
```bash
Required amounts
...
Example Input:
```bash
java -jar e-liquid-calculator-1.0.0-jar-with-dependencies.jar -a 800 -p 0.5 -v 0.5
```
Result:
```bash
Required amounts
...
```bash
java -Duser.language=de -Duser.country=DE -jar e-liquid-calculator-1.0.0-jar-with-dependencies.jar
```
...
- English (default):
  ```bash
  java -Duser.language=en -Duser.country=EN -jar e-liquid-calculator-1.0.0-jar-with-dependencies.jar
  ```
- German:
  ```bash
  java -Duser.language=de -Duser.country=DE -jar e-liquid-calculator-1.0.0-jar-with-dependencies.jar
...
#### Verwendung des kompilierten JAR
